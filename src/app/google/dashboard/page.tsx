...
const MOCK_DATA: DashboardData = {
    campaigns: [
        {
            id: '1',
            name: 'YouTube Brand Awareness - Summer 2026',
            status: 'ENABLED',
            type: 'VIDEO',
            clicks: 12456,
            impressions: 456789,
        ...
        {
            id: '2',
            name: 'Display Retargeting - Existing Customers',
            status: 'ENABLED',
            type: 'DISPLAY',
            clicks: 3456,
            impressions: 123456,
    ...
    adGroups: [
        {
            id: '1',
            name: 'Ad Group - Brand Awareness',
            campaignName: 'YouTube Brand Awareness - Summer 2026',
            status: 'ENABLED',
            clicks: 5678,
            impressions: 234567,
            cost: 5678.90,
        ...
        },
        {
            ...
            campaignName: 'Display Retargeting - Existing Customers',
            status: 'ENABLED',
            clicks: 2345,
            impressions: 98765,
            cost: 2345.67,
        ...
        },
        {
            ...
            campaignName: 'Search - High Intent Keywords',
            status: 'PAUSED',
            clicks: 4567,
            impressions: 54321,
            cost: 4567.89,
    ...
    ads: [
        {
            id: '1',
            name: 'Video Ad - Summer Vibes',
            type: 'VIDEO',
            adGroupName: 'Ad Group - Brand Awareness',
            campaignName: 'YouTube Brand Awareness - Summer 2026',
            clicks: 3456,
            impressions: 123456,
            cost: 3456.78,
            ...
            description: 'Shop our summer collection today!',
        ...
        {
            id: '3',
            name: 'Display Ad - Banner 300x250',
            type: 'DISPLAY',
        ...
        {
            id: '4',
            name: 'Search Ad - High Intent Keywords',
            type: 'SEARCH',
            ...
            cost: 3456.78,
            ctr: 10.00,
            headline: 'Best Deals on Premium Products',
            description: 'Shop now and save big!',
            finalUrl: 'https://example.com/premium-products',
        },
        {
            id: '5',
            name: 'Shopping Ad - Product A',
            type: 'SHOPPING',
            adGroupName: 'Ad Group - Best Sellers',
            campaignName: 'Shopping - Product Catalog',
            clicks: 6789,
            impressions: 67890,
            cost: 4567.89,
            ctr: 10.00,
            headline: 'Product A - Best Seller',
            description: 'Limited time offer',
            finalUrl: 'https://example.com/product-a',
        },
        {
            id: '6',
            name: 'Shopping Ad - Product B',
            type: 'SHOPPING',
            adGroupName: 'Ad Group - Best Sellers',
            campaignName: 'Shopping - Product Catalog',
            clicks: 4567,
...
const CampaignTable = ({ campaigns }: { campaigns: Campaign[] }) => {
    ...
    const getTypeColor = (type: string) => {
        const typeMap: Record<string, string> = {
            ...
            PERFORMANCE_MAX: 'bg-indigo-500/15 text-indigo-400',
        };
...
// This component uses useParams and useSearchParams
function DashboardContentWrapper() {
    ...
    // Get query params
    const developerToken = searchParams.get('developerToken');
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // const response = await fetch(`/api/google/${customerId}/dashboard?dateRange=${selectedDateRange}&developerToken=${developerToken}&accessToken=${accessToken}`);
        ...
        fetchData();
    }, [customerId, selectedDateRange, developerToken, accessToken]);
    ...
    // If no data, show empty state with zeros
    if (!data) {
        ...
        return <DashboardContent data={emptyData} customerId={customerId as string} />;
    }

    return <DashboardContent data={data} customerId={customerId as string} />;
}

// ============= DASHBOARD CONTENT =============

function DashboardContent({ data, customerId }: { data: DashboardData; customerId: string }) {
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4">
                        <p className="text-xs text-slate-500 dark:text-slate-400">Average CTR</p>
                        <p className="text-lg font-semibold text-slate-900 dark:text-white">
